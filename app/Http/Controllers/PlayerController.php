        ...
        return [
            'players' => $query
                ...
                ->map(function (Planet $planet) {
                    ...
                    $return['last_spy_report'] = $return['last_spy_report'] ? Carbon::parse($return['last_spy_report'])->subMinute()->subHour()->format('.d.m. H:i') . 'min' : '';
                    ...
                    $return['last_battle_report'] = $return['last_battle_report'] ? Carbon::parse($return['last_battle_report'])->subMinute()->subHour()->format('.d.m. H:i') . 'min' : '';
