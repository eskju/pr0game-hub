...
class PlayerController extends Controller
{
    ...
    public function overview(Request $request): array
    {
        ...
        $players = $players->map(function (Planet $planet) {
            ...
            $return['last_spy_report_hours'] = $return['last_spy_report'] ? abs(Carbon::parse($return['last_spy_report'])->subMinute()->addHour()->diffInHours(Carbon::now())) : '';
            $return['last_spy_report'] = $return['last_spy_report'] ? $this->getDateTime(Carbon::parse($return['last_spy_report'])->subMinute()->addHour()) : '';
            $return['last_battle_report_hours'] = $return['last_battle_report'] ? abs(Carbon::parse($return['last_battle_report'])->subMinute()->addHour()->diffInHours(Carbon::now())) : '';
            $return['last_battle_report'] = $return['last_battle_report'] ? $this->getDateTime(Carbon::parse($return['last_battle_report'])->subMinute()->addHour()) : '';
            ...
            $return['inactive_since'] = $return['inactive_since'] ? Carbon::parse($return['inactive_since'])->addHour()->diffInHours(Carbon::now(), true) : null;
