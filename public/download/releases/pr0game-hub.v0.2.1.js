...
(function () {
    ...
    window.getPlayerRowStyle = function (obj, ownScore) {
        obj.score = (obj.score.replace(/\./, '') || 0).toString();
    ...
    window.getPlayerScoreStyle = function (obj) {
        return {color: getColor([0, 0, 255], parseInt(obj.score.replace(/\./,'')) / scoreThreshold)};
    }

    window.getPlayerScoreBuildingStyle = function (obj) {
        return {color: getColor([0, 255, 0], parseInt(obj.score_building.replace(/\./,'')) / buildingThreshold)};
    }

    window.getPlayerScoreScienceStyle = function (obj) {
        return {color: getColor([255, 0, 255], parseInt(obj.score_science.replace(/\./,'')) / scienceThreshold)};
    }

    window.getPlayerScoreMilitaryStyle = function (obj) {
        return {color: getColor([255, 0, 0], parseInt(obj.score_military.replace(/\./,'')) / militaryThreshold)};
    }

    window.getPlayerScoreDefenseStyle = function (obj) {
        return {color: getColor([255, 255, 0], parseInt(obj.score_defense.replace(/\./,'')) / defenseThreshold)};
    }
