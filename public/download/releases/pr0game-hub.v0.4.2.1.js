...
// 0.4.1         skin changes
// 0.4.2         bugfix for building & research levels
...
(function() {
    ...
    window.PageOverview = function()
    {
        ...
        this.prepareHtml = function() {
            ...
            const planetInfo = {
                image: null,
                fieldsUsed: infos[5].match(/bebaute Felder\"\>([0-9]+)\</),
                fieldsTotal: infos[5].match(/bebaubare Felder\"\>([0-9]+)\</),
                temperatureMin: infos[6].match(/von ([-0-9]+)\°/),
                temperatureMax: infos[6].match(/bis ([-0-9]+)\°/)
            };
