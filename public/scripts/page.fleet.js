    ...
    this.showExpoButton = function () {
        $('.table519').each(function (key, obj) {
            if ($(obj).html().search(/Neuer Auftrag:/) !== -1) {
                $(obj).find('tr th').append('<a class="text-red" href="javascript:void(0)" style="margin-left: 10px" onclick="pageFleet.setExpoFleet()">Expo Ress GT</a> //');
                $(obj).find('tr th').append('<a class="text-red" href="javascript:void(0)" onclick="pageFleet.setExpoFleet(true)">Expo Schiffe GT</a> // ');
                $(obj).find('tr th').append('<a class="text-red" href="javascript:void(0)" onclick="pageFleet.setExpoFleet(false, false)">Expo Ress KT</a> //');
                $(obj).find('tr th').append('<a class="text-red" href="javascript:void(0)" onclick="pageFleet.setExpoFleet(true, false)">Expo Schiffe KT</a>');
            }
        });
    }
