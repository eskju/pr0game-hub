        ...
        getJSON('hub/research', function (response) {
            ...
            $.each(data, function (key, obj) {
                if (allianceId === '' || parseInt(allianceId) === obj.alliance_id) {
                    ...
                    html += '<td style="border-right: 1px solid rgba(255, 255, 255, 0.75); text-align: right; color: ' + getColorAlt(cGreen, parseInt(obj.computer_tech || 0) / getMaxValue(data, 'computer_tech'), cRed) + '">' + (obj.computer_tech || '') + '</td>';
                    ...
                    html += '<td style="border-right: 1px solid rgba(255, 255, 255, 0.75); text-align: right; color: ' + getColorAlt(cGreen, parseInt(obj.shield_tech || 0) / getMaxValue(data, 'shield_tech'), cRed) + '">' + (obj.shield_tech || '') + '</td>';
                    ...
                    html += '<td style="border-right: 1px solid rgba(255, 255, 255, 0.75); text-align: right; color: ' + getColorAlt(cGreen, parseInt(obj.combustion_tech || 0) / getMaxValue(data, 'combustion_tech'), cRed) + '">' + (obj.combustion_tech || '') + '</td>';
                    ...
                    html += '<td style="border-right: 1px solid rgba(255, 255, 255, 0.75); text-align: right; color: ' + getColorAlt(cGreen, parseInt(obj.laser_tech || 0) / getMaxValue(data, 'laser_tech'), cRed) + '">' + (obj.laser_tech || '') + '</td>';
                    ...
                    html += '<td style="border-right: 1px solid rgba(255, 255, 255, 0.75); text-align: right; color: ' + getColorAlt(cGreen, parseInt(obj.buster_tech || 0) / getMaxValue(data, 'buster_tech'), cRed) + '">' + (obj.buster_tech || '') + '</td>';
                    ...
                    html += '<td style="border-right: 1px solid rgba(255, 255, 255, 0.75); text-align: right; color: ' + getColorAlt(cGreen, parseInt(obj.crystal_proc_tech || 0) / getMaxValue(data, 'crystal_proc_tech'), cRed) + '">' + (obj.crystal_proc_tech || '') + '</td>';
