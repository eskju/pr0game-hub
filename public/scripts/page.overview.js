window.PageOverview = function () {
    ...
    this.analyzeFleetMovement = function () {
        ...
        postJSON('flights', {activities}, function (response) {
            ...
            html += '</table>';
            html += '<small class="text-left" style="display: block; color: ' + getRgb(cRed) + '; padding-top: 10px; margin-top: 10px; border-top: 1px solid #222">Die Expos werden erst seit dem 04.04. getrackt. Bis zum 06.04. kann es somit zu falschen Angaben kommen. Metall/Kristall/Deuterium/Punkte berechnen den Ressourcengewinn, sowie Schiffsgewinn und -verlust (Produktionskosten) mit ein. Komplettverluste (depleted/black hole) sowie Expo-Abbrüche werden <u>NICHT</u> erfasst. Expos werden nur erfasst, wenn nach Erhalt der Expo-Nachricht die Übersicht mit diesem Plugin geöffnet wurde.</small>';
